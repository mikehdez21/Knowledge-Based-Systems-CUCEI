...
(deffacts customers
  ...
  (customer (customer-id 104) (name alice) (address bla bla bla) (phone 123456789))
...
(deffacts items-list
	(line-item (order-number 300) (customer-id 102) (part-number 1234) (quantity 25))
	(line-item (order-number 301) (customer-id 103) (part-number 2341) (quantity 10))
        (line-item (order-number 302) (part-number 1234) (customer-id 104) (quantity 3))
)
